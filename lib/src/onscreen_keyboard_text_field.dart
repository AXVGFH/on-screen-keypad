...
class OnscreenKeyboardTextField extends StatefulWidget {
  ...
  /// An optional validation function that checks the text value.
  ///
  /// If the value is invalid, this function should return an error message
  /// (a non-null String). If the value is valid, this function should return
  /// null.
  ///
  /// This function is called during form validation when a [Form] is validated.
  ///
  /// Example:
  /// ```dart
  /// validator: (value) {
...
class OnscreenKeyboardTextFieldState extends State<OnscreenKeyboardTextField> {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      validator: widget.validator, // <-- تمرير validator هنا
    );
  }
}